...
import com.globant.training.google.maps.export.service.FusionTablesExportService;
import com.globant.training.google.maps.export.service.fusiontables.FusionTablesService;
import com.globant.training.google.maps.export.service.fusiontables.FusionTablesServiceImpl;
...
public class GuiceConfig extends GuiceServletContextListener {
  ...
  public static class MapsModule extends AbstractModule {
    ...
    protected void configure() {
      ...
      bind(ExportService.class).to(FusionTablesExportService.class);
