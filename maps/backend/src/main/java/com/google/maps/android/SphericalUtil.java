...
public class SphericalUtil {
   ...
   * "Area of a spherical triangle given two edges and the included angle" as per
   * "Spherical Trigonometry" by Todhunter, page 71, section 103, point 2. See
   * http://books.google.com/books?id=3uBHAAAAIAAJ&pg=PA71 The arguments named "tan" are tan((pi/2 -
   * latitude)/2).
   */
